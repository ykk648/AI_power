...
from body_lib.body_kp_detector.body_detector_movenet.movenet_utils import crop_and_resize_tf, init_crop_region, \
    determine_crop_region, \
    draw_prediction_on_image

# from apstone.onnx_model import ONNXModel
...
if __name__ == '__main__':
    ...
    with CVVideoLoader('') as cvvl:
        for i in tqdm(range(len(cvvl))):
            ...
            # CVImage(output_overlay).save('/{}.jpg'.format(i))
