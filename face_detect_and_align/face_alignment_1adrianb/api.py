...
default_model_urls = {
    '2DFAN-4': './pretrain_models/face_detect/face_alignment_1adrianb/2DFAN4-cd938726ad.zip',
    '3DFAN-4': './pretrain_models/face_detect/face_alignment_1adrianb/3DFAN4-4a694010b9.zip',
...
class FaceAlignment:
    def __init__(self, landmarks_type, network_size=NetworkSize.LARGE,
        ...
        face_detector_module = __import__('face_detect_and_align.face_alignment_1adrianb.detection.' + face_detector,
    ...
    def get_landmarks(self, rgb_image_or_path, detected_faces=None, return_bboxes=False, return_landmark_score=False):
        """Deprecated, please use get_landmarks_from_image

        Arguments:
            rgb_image_or_path {string or numpy.array or torch.tensor} -- The input image or path to it
        ...
        """
        return self.get_landmarks_from_image(rgb_image_or_path, detected_faces, return_bboxes, return_landmark_score)
