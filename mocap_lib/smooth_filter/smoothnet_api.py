...
class SmoothNetFilter:
    ...
    def __init__(
        ...
        self.window_size = window_size
        self.device = device
        self.smoothnet = SmoothNet(window_size, window_size, )
...
if __name__ == '__main__':
    sf = SmoothNetFilter(8, 'pretrain_models/mocap_lib/smooth_filter/smoothnet_ws8_h36m.pth')
    input = np.zeros((64, 21, 2))
    print(sf(input))
