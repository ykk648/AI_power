...
if __name__ == "__main__":
    ...
    local_doc_qa.init_knowledge_vector_store('/mnt/ljt/dataset/NLP/liurun_article.txt')

    # query = "我想要经营餐饮店应该怎么选位置？"
    # vs_path = "./vector_store/liurun_article_FAISS_20230506_174633"
    # last_print_len = 0
