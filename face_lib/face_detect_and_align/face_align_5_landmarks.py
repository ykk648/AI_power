...
class FaceDetect5Landmarks:
    ...
    def get_single_face(self, crop_size, mode='mtcnn_512', apply_roi=False, only_roi=False, pad_ratio=0):
        """
        Args:
            crop_size:
        ...
        if apply_roi:
            ...
            align_img, mat_rev = norm_crop(self.image, kpss, crop_size, mode=mode)
            align_img = cv2.cvtColor(align_img, cv2.COLOR_RGB2BGR)
